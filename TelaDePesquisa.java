...
public class TelaDePesquisa extends JFrame {
    ...
    public final JLabel lblNotificaçoes;
    ...
    public TelaDePesquisa() {
        ...
        JPanel linhaNotificaçoes = new JPanel(new GridLayout(1,1));
        lblNotificaçoes = new JLabel("Notificações", SwingConstants.CENTER);
        linhaNotificaçoes.add(lblNotificaçoes);
        add(linhaNotificaçoes);
